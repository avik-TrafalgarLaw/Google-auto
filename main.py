...
def process_files_to_cad(files_to_load, output_file):
    ...
    try:
        ...
        for product_type, file_info in files_to_load.items():
            ...
            product_templates = {
                "natural": {
                    "title": lambda row: f"{row['shape']}-{row['carats']} Carats-{row['col']} Color-{row['clar']} Clarity-{row['lab']} Certified-{row['ReportNo']}-Natural Diamond",
                ...
                "lab_grown": {
                    "title": lambda row: f"{row['shape']}-{row['carats']} Carats-{row['col']} Color-{row['clar']} Clarity-{row['lab']} Certified-{row['ReportNo']}-Lab Grown Diamond",
